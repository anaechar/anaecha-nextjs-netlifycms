...
We will use NextJs Severless Function provided by Vercel to handling authorization via API endpoints.
...
8. Push your codes to the repository by running these commands
